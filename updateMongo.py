...
def calculateExchangeIncome(c, checkValues=True):
...
if __name__ == '__main__':
    ...
    validated, currencyKeys = validateRawData(currencies)
    tools.printIf('Validation: OK', validated)
